...
export default function HomesList() {
    ...
    return (
        <div className=" bg-gradient-to-b from-black to-slate-900  items-center justify-center p-4">
            {/* 🔙 Back Button */}
            <button
                onClick={() => router.back()}
                className="
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
                {filteredHomes.map((home) => (
                    ...
                    >
                        ...
                        >
                            {/* Image */}
                            <div className="w-full h-40 bg-gray-100  w-full max-w-md bg-black rounded-2xl p-6 border border-blue-500 shadow-[0_0_25px_#2563eb]">
                                <img
